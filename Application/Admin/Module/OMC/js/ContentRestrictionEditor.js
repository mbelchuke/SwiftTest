...
Dynamicweb.Controls.OMC.ContentRestrictionEditor = function (options) {
...
Dynamicweb.Controls.OMC.ContentRestrictionEditor.prototype.hasPermission = function (permissionLevel) {
    /// <summary>Gets the reference to DOM element that contains all the UI.</summary>
    return permissionLevel <= this._options.permissionLevel;
}
...
Dynamicweb.Controls.OMC.ContentRestrictionEditor.prototype.choose = function (type) {
    ...
    var editAllowed = this.hasPermission(PermissionLevels.Edit);
    if (type == 'notActive') {
        ...
        this._cache.choicePresetContent.disabled = !editAllowed;
        this._cache.choiceCreateContent.disabled = true;
        ...
        this.get_presetDropDown().set_isEnabled(false);
        for (var i = 0; i < this._cache.choiceCreateProfiles.length; i++) {
            this._cache.choiceCreateProfiles[i].disabled = !editAllowed;
        }

        if (this._cache.choiceCreateSelectAll) {
            this._cache.choiceCreateSelectAll.disabled = !editAllowed;
        }

        if (this._cache.choiceCreateUnSelectAll) {
            this._cache.choiceCreateUnSelectAll.disabled = !editAllowed;
        }

        if (this._cache.newPresetText) {
            this._cache.newPresetText.disabled = !this.hasPermission(PermissionLevels.Create);
        }

        if (this._cache.evaluationTypeRecognized) this._cache.evaluationTypeRecognized.disabled = !editAllowed;
        if (this._cache.evaluationTypePrimary) this._cache.evaluationTypePrimary.disabled = !editAllowed;

        if (this._cache.applyModeShow) this._cache.applyModeShow.disabled = !editAllowed;
        if (this._cache.applyModeHide) this._cache.applyModeHide.disabled = !editAllowed;

        this._cache.choicePresetContent.disabled = true;
        this._cache.choiceCreateContent.disabled = !editAllowed;
    }
    if (!editAllowed) {
        this._cache.choiceNotActive.disabled = true;
        this._cache.choicePreset.disabled = true;
        this._cache.choiceCreate.disabled = true;
    } 
}

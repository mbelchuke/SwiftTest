<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GridRowTemplateEdit.aspx.vb" Inherits="Dynamicweb.Admin.GridRowTemplateEdit" %>
...
<body>
    <div class="card">
        <form runat="server" action="GridRowTemplateEdit.aspx" method="post">
